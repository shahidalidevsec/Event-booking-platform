...
import CityPresence from "./CityPresence";
    ...
    <>
      ...
      <div className="flex flex-col min-h-screen">
        ...
        {/* <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16 px-4">
                <div className="bg-white  bg-[url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTLanSfIJMSYIOoGst2gEULYNmAmmtY074hhFhachnW1w&s=10')] bg-cover bg-center rounded-3xl shadow-sm border-2 border-[#070E24] flex flex-col items-center text-center hover:-translate-y-1 transition duration-300">
                    
                    <h3 className="text-4xl font-extrabold  font-serif mt-17  text-white mb-3">Fast Booking</h3>
                    <p className="text-gray-900 text-sm leading-relaxed">Secure your tickets instantly with our fast streamlined booking infrastructure built for speed.</p>
                </div>
                <div className="bg-white  bg-[url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQN1XEIeQj3AVInuAenWKJYA9OgmVTbk2GznlpZ11c4xw&s=10')] bg-cover bg-center rounded-3xl shadow-sm border-2 border-[#070E24] flex flex-col items-center text-center hover:-translate-y-1 transition duration-300">
                ...
                <div className=" p-8  bg-white  bg-[url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT83NTb8Jwh4SpwybjkT8mdmCdylzIrlaMcH6iBLkeh4w&s=10')] bg-cover bg-center rounded-3xl shadow-sm border-2 border-[#070E24] flex flex-col items-center text-center hover:-translate-y-1 transition duration-300">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16 px-4">
          {/* Fast Booking */}
          <div className="relative h-[240px] overflow-hidden bg-[url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTLanSfIJMSYIOoGst2gEULYNmAmmtY074hhFhachnW1w&s=10')] bg-cover bg-center rounded-3xl shadow-sm border-3 border-gray-500 hover:-translate-y-1 transition duration-300">
            {/* Dark Overlay */}
            <div className="absolute inset-0 bg-black/45"></div>

            {/* Text */}
            <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-6">
              <h3 className="text-4xl font-extrabold font-serif text-white mb-3 drop-shadow-lg">
                Fast Booking
              </h3>
          ...
          {/* Seamless Access */}
          <div className="relative h-[240px] overflow-hidden bg-[url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQN1XEIeQj3AVInuAenWKJYA9OgmVTbk2GznlpZ11c4xw&s=10')] bg-cover bg-center rounded-3xl shadow-sm border-3 border-gray-500 hover:-translate-y-1 transition duration-300">
            {/* Dark Overlay */}
            <div className="absolute inset-0 bg-black/45"></div>
            ...
            <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-6">
              ...
              <p className="text-white text-sm leading-relaxed drop-shadow-md">
                ...
                personal dashboard with easily.
              </p>
            </div>
          </div>

          {/* Secure Platform */}
          <div className="relative h-[240px] overflow-hidden bg-[url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ8iTxp70A6fMCTctkC49oFob8xqE8RqdcheyyBuhc9fg&s=10')] bg-cover bg-center rounded-3xl shadow-sm border-3 border-gray-500 hover:-translate-y-1 transition duration-300">
            {/* Dark Overlay */}
            <div className="absolute inset-0 bg-black/45"></div>
